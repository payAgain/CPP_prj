#ifndef  __DREAMER_D_HOOK_H__
#define __DREAMER_D_HOOK_H__
...
/**
 *   hook的实现原理
 *   1. 为函数签名定义别名 sleep_fun
 *   2. 利用dlsym获取stdc 库中的 sleep定义函数指针实现(句柄 handler)
 *   3. 覆盖sleep函数的定义，在需要hook的时候执行自己代码的内容，否则执行句柄函数.
 */
namespace dreamer {
