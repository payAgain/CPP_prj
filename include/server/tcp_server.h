#ifndef __DREAMER_SERVER_TCP_SERVER_H__
#define __DREAMER_SERVER_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(dreamer::IOManager* worker = dreamer::IOManager::GetThis()
              ,dreamer::IOManager* io_woker = dreamer::IOManager::GetThis()
              ,dreamer::IOManager* accept_worker = dreamer::IOManager::GetThis());
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(dreamer::Address::ptr addr);
