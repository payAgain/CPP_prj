#ifndef __DREAMER_D_SOCKET_H__
#define __DREAMER_D_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(dreamer::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(dreamer::Address::ptr address);
...
//     static SSLSocket::ptr CreateTCP(dreamer::Address::ptr address);
